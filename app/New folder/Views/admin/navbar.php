...
">
    ...
    ">
        ...
        $navItems = [
            ['label' => 'Applications', 'hash' => 'applicationsSection'],
            ['label' => 'Charts',      'hash' => 'statusCharts'],
            ['label' => 'Analytics',   'hash' => 'analytics'],
            ['label' => 'Roles',       'hash' => 'rolesSection'],
        ];
        foreach ($navItems as $item):
            $hash = $item['hash'];
            $href = $isDashboard ? "#$hash" : base_url("admin/dashboard#$hash");
