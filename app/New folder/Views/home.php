...
<body>
    ...
    <div class="hero">
        ...
        <div class="btn-group">
            ...
            <a href="#admin-login" class="btn btn-outline btn-lg">Admin Login</a>
        </div>
    </div>
    ...
    <div class="main-wrapper">
        ...
        <div class="card" id="admin-login">
            <h2><!--<span class="section-icon">&#128272;</span>-->Admin Login</h2>
        ...
        <div class="cta-banner" id="ctaBanner">
            ...
            <button class="btn btn-success btn-lg" onclick="showApplicationForm()">Apply For a Job</button>
        </div>

        <!-- Application form (with 1-2-3 indicator) -->
        <div id="applicationContainer">
            <div class="card" style="margin-top:20px;">
                <h2><!--<span class="section-icon">&#128196;</span>-->Job Application Form</h2>

                <!-- Step indicator (1-2-3) -->
                <div class="step-indicator" id="stepIndicator">
                    <div class="step-dot"><span class="circle active" id="circ1" onclick="nextStep()">1</span></div>
                    <div class="step-line" id="line1"></div>
                    <div class="step-dot"><span class="circle" id="circ2" onclick="nextStep()">2</span></div>
                    <div class="step-line" id="line2"></div>
                    <div class="step-dot"><span class="circle" id="circ3" onclick="nextStep()">3</span></div>
                </div>
    ...
    <script>
        ...
        function showStep(index) {
            ...
            document.getElementById('applicationContainer').scrollIntoView({
                behavior: 'smooth',
                block: 'start'
            });
        }
